...
{
    /// <inheritdoc />
    public partial class Refactor_CartOrders_Images : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CartItem_ExactlyOneRef", "(CASE WHEN \"Model3DId\" IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN \"ProjectId\" IS NOT NULL THEN 1 ELSE 0 END) = 1");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Models_Model3DId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModelImages_Models_Model3DId",
                        column: x => x.Model3DId,
                        principalTable: "Models",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItem_ExactlyOneRef", "(CASE WHEN \"Model3DId\" IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN \"ProjectId\" IS NOT NULL THEN 1 ELSE 0 END) = 1");
                    table.ForeignKey(
                        name: "FK_OrderItems_Models_Model3DId",
                        column: x => x.Model3DId,
                        principalTable: "Models",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_Model3DId",
                table: "CartItems",
                columns: new[] { "CartId", "Model3DId" },
                unique: true,
                filter: "\"Model3DId\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_ProjectId",
                table: "CartItems",
                columns: new[] { "CartId", "ProjectId" },
                unique: true,
                filter: "\"ProjectId\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_Model3DId",
                table: "CartItems",
                column: "Model3DId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModelImages_Model3DId_Order",
                table: "ModelImages",
                columns: new[] { "Model3DId", "Order" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderId_Model3DId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderId_ProjectId",
                table: "OrderItems",
                columns: new[] { "OrderId", "ProjectId" },
                unique: true,
                filter: "\"ProjectId\" IS NOT NULL");
